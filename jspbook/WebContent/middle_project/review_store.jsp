...
<%
	...
	Object productname = application.getAttribute("product_review");
	
	//String productname = request.getParameter("product_review");
	...
	if(msgs == null) {
		...
		application.setAttribute("product_name", productname);
	}
